...
This module implements a wavetable oscillator with morphing capabilities.
...
WavetableOscillator is compatible with [WaveEdit Online](https://waveeditonline.com/) format.

This package provides a couple of helper functions:
