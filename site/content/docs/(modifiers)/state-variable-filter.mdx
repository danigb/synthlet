...
[![NPM Version](https://img.shields.io/npm/v/@synthlet/state-variable-filter?label=@synthlet/state-variable-filter&color=%2322d3ee)](https://www.npmjs.com/package/@synthlet/state-variable-filter)
