...
- 4caf430: Remove the second, undocumented pink noise algorithm. Passing the raw `type`
...
- 4caf430: Stop warning on an unrecognised `type`. Because `type` is an AudioParam, a
