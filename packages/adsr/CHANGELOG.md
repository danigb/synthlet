...
- 792d627: `AdsrAmp` no longer dies when nothing is connected to its input. It passed
...
- 792d627: Rewrite the package README. It documented `createVca`/`createAdsr`,
...
- 792d627: `AdsrAmp` now processes every channel of its input instead of only the first: a
