...
Compilation options: -lang rust -fpga-mem-th 4 -ct 1 -cn Korg35LPF -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0
------------------------------------------------------------ */
...
impl Korg35LPF {
	...
	pub fn metadata(&self, m: &mut dyn Meta) { 
		m.declare("compile_options", r"-lang rust -fpga-mem-th 4 -ct 1 -cn Korg35LPF -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0");
		m.declare("filename", r"korg35-lpf.dsp");
		m.declare("maths.lib/author", r"GRAME");
		m.declare("maths.lib/copyright", r"GRAME");
		m.declare("maths.lib/license", r"LGPL with exception");
		m.declare("maths.lib/name", r"Faust Math Library");
		m.declare("maths.lib/version", r"2.9.0");
		m.declare("name", r"korg35-lpf");
		m.declare("platform.lib/name", r"Generic Platform Library");
		m.declare("platform.lib/version", r"1.3.0");
		m.declare("vaeffects.lib/korg35LPF:author", r"Eric Tarr");
		m.declare("vaeffects.lib/korg35LPF:license", r"MIT-style STK-4.3 license");
	...
	pub fn build_user_interface_static(ui_interface: &mut dyn UI<FaustFloat>) {
		ui_interface.open_vertical_box("korg35-lpf");
	...
	pub fn compute(
		...
		let mut fSlow3: F32 = 9.293 * (self.fHslider1) as F32 + -0.00010678119;
		let mut fSlow4: F32 = 1.0 - fSlow2;
		let mut fSlow5: F32 = 1.0 / (1.0 - 0.21521823 * (fSlow0 * fSlow3 * fSlow4 / fSlow1));
		let mut fSlow6: F32 = 1.0 / fSlow1;
		let mut fSlow7: F32 = 0.21521823 * fSlow3 * fSlow4;
		let mut fSlow8: F32 = 2.0 * fSlow2;
		let mut fSlow9: F32 = 0.21521823 * fSlow3;
		let zipped_iterators = inputs0.zip(outputs0);
		for (input0, output0) in zipped_iterators {
			let mut fTemp0: F32 = (*input0) as F32 - self.fRec3[1];
			let mut fTemp1: F32 = fSlow5 * (self.fRec3[1] + fSlow6 * (fSlow0 * fTemp0 + fSlow7 * self.fRec1[1] - self.fRec2[1])) - self.fRec1[1];
			let mut fTemp2: F32 = self.fRec1[1] + fSlow2 * fTemp1;
			let mut fRec0: F32 = fTemp2;
			self.fRec1[0] = self.fRec1[1] + fSlow8 * fTemp1;
			self.fRec2[0] = self.fRec2[1] + fSlow8 * (fSlow9 * fTemp2 - self.fRec2[1]);
			self.fRec3[0] = self.fRec3[1] + fSlow8 * fTemp0;
