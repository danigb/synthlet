...
Compilation options: -lang rust -fpga-mem-th 4 -ct 1 -cn Diode -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0
------------------------------------------------------------ */
...
impl Diode {
	...
	pub fn metadata(&self, m: &mut dyn Meta) { 
		m.declare("compile_options", r"-lang rust -fpga-mem-th 4 -ct 1 -cn Diode -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0");
	...
	pub fn compute(
		...
		let mut fSlow0: F32 = F32::max(0.0, F32::min(1.0, 0.33333334 * (F32::log10(0.5 * (self.fHslider0) as F32) + -1.0)));
		let mut fSlow1: F32 = F32::tan(self.fConst0 * F32::powf(1e+01, 3.0 * fSlow0 + 1.0));
		...
		let mut fSlow15: F32 = 17.0 - 9.7 * F32::powf(fSlow0, 1e+01);
		let mut fSlow16: F32 = 24.293 * (self.fHslider1) as F32 + -0.00010678119;
		...
		for (input0, output0) in zipped_iterators {
			let mut fTemp0: F32 = F32::max(-1.0, F32::min(1.0, 1e+02 * (*input0) as F32));
