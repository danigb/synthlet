import { createDigitalDelay, DEFAULT_MAX_TIME } from "./dsp";
...
export class DigitalDelayProcessor extends AudioWorkletProcessor {
  r: boolean; // running
  u: ReturnType<typeof createDigitalDelay>["update"];
  g: ReturnType<typeof createDigitalDelay>["compute"];

  constructor(options?: AudioWorkletNodeOptions) {
    super();
    this.r = true;
    const { compute, update } = createDigitalDelay(
      sampleRate,
...
registerProcessor("DigitalDelayProcessor", DigitalDelayProcessor);
