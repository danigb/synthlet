...
import { PluckFilterType, PluckPosFilter } from "./pluck-pos-filter";
...
export class KarplusStrongOscillator {
  ...
  private bodyFilter: ParametricFilter = new ParametricFilter(); // simple parameteric filter for adding a resonant hump to th output
